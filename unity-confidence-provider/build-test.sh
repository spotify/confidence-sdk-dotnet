...
# Unity Confidence Provider Build Test Script
...
TEST_DIR="../test-unity-confidence-project"
...
# Add our packages to the project
echo "📦 Adding Unity OpenFeature SDK and Confidence Provider packages..."
cat > "$TEST_DIR/Packages/manifest.json" << EOF
{
  "dependencies": {
    "com.unity.openfeature": "file:../../unity-openfeature-sdk",
    "com.spotify.confidence.unity": "file:../../unity-confidence-provider",
...
# Check results
if [ $? -eq 0 ]; then
    echo "✅ BUILD SUCCESSFUL! Unity Confidence Provider compiled without errors."
...
echo "🎉 Unity Confidence Provider build test completed successfully!"